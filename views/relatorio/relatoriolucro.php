...
?>
    ...
    <div class="relatorio-form">
        ...
        <div class="form-group">
            ...
            ?>
            <?=
            Html::a('Gerar PDF', ['pdflucro', 'id' => $modelRelatorio->idrelatorio], [
                'class' => 'btn btn-danger',
                'target' => '_blank',
                'data-toggle' => 'tooltip',
                'title' => 'Clique para gerar um PDF',
                'disabled' =>
                    (isset($modelRelatorio->idrelatorio) && count($lucros) > 0) ?
                        false : true,
            ]);
            ?>
        </div>
...
<?php
if (isset($modelRelatorio->idrelatorio) && count($lucros) > 0) {
